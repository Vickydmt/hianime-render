<section class="block_area block_area_category lazy-component" data-component="category">
    ...
    $filteredAnimeList = array_filter($json['results']['data'], function($anime) {
        return empty($anime['adultContent']) || $anime['adultContent'] === false;
    });
    // Limit to 12 items
    $animeList = array_slice($filteredAnimeList, 0, 12);
