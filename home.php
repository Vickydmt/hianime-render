...
if (!$data || !$data['success']) {
    echo "API request failed and no cache available.";
    exit;
}
...
<head>
    ...
    <meta name="google-site-verification" content="d4zjyLiVn7AXWAMMdrWY-NzhEEDkIpPWnLmkcYugRhw" />
