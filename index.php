...
<head>
    <title>
        <?= $websiteTitle ?> - Watch Anime Online, Free Anime Streaming Online on HiAnime.xyz Anime Website
    </title>

    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="robots" content="index,follow" />
    <meta http-equiv="content-language" content="en"/>
    <meta name="description" content="HiAnime is a Free anime streaming website which you can watch English Subbed and Dubbed Anime online with No Account and Daily update. WATCH NOW!"/>
    <meta property="og:title" content="Watch Anime Online, Free Anime Streaming Online on HiAnime.to Anime Website"/>
    <meta name="keywords"
        content="anime streaming, watch anime online, free anime streaming, anime episodes, anime movies, anime series, HD anime, anime website, latest anime, popular anime, anime streaming site, dubbed anime, subbed anime, stream anime online, anime library, new anime releases, anime genres, anime in HD, anime with subtitles, online anime, An-Streamz, anime streaming platform, anime to watch, watch anime,anime online, free anime online, online anime, anime streaming, stream anime online, english anime, english dubbed anime" />
    ...
    <link rel="icon" sizes="192x192" href="<?=$websiteUrl?>/public/android-chrome-192x192.png?v=<?=$version?>">
    <link rel="stylesheet"
            ...
            <div id="mw-top">
                <div class="container">
                    <div class="mwt-content">
                        <div class="mwt-icon"><img src="<?= $websiteUrl ?>/public/images/intro.webp" onerror="this.onerror=null; this.src='<?= $websiteUrl ?>/public/images/zorowaifu.png';">
                        </div>
                        <div class="mwh-logo">
                            ...
                            <div class="zr-connect zr-connect-list">
                                ...
                                <div class="connecting-list">
                                    <div class="item">
                                        ...
                                        <h4 class="item-name"><a href="/community/post/constructing-new-features-243342">Enhancing Your Streaming Experience with New Features</a></h4>
<div class="subject">
    <div>We're currently developing and implementing new features designed to elevate your anime streaming experience on HiAnime. Stay tuned for exciting updates coming soon!</div>
</div>
                                        <div class="cn-owner">
                                            <div class="profile-avatar">
                                                <img src="<?= $websiteUrl ?>/public/images/profile.jpg" alt="Admin">
                                            </div>
        ...
        <div id="xfooter-about">
            <div class="container">
                <p class="copyright">©
                    <?php echo date("Y"); ?> <a href="<?= $websiteUrl ?>">Hianime</a>. All rights reserved.
                </p>
            </div>
        </div>
        <!--End: Footer-->
